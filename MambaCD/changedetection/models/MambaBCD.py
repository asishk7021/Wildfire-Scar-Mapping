...
class STMambaBCD(nn.Module):
    def __init__(self, pretrained, **kwargs):
        ...
        norm_layer: nn.Module = _NORMLAYERS.get(kwargs['norm_layer'].lower(), None) #* set to 'ln' by default.       
        ssm_act_layer: nn.Module = _ACTLAYERS.get(kwargs['ssm_act_layer'].lower(), None) #* set to 'silu' by default.
        mlp_act_layer: nn.Module = _ACTLAYERS.get(kwargs['mlp_act_layer'].lower(), None) #* set to 'gelu' by default.
        ...
        self.main_clf = nn.Conv2d(in_channels=128, out_channels=2, kernel_size=1) #* Main classifier
