...
_C.MODEL.NUM_CLASSES = 2 #HACK Set number of classes here
# Dropout rate
...
_C.MODEL.VSSM.IN_CHANS = 9 #HACK Set input channels here
_C.MODEL.VSSM.DEPTHS = [2, 2, 9, 2] #? What is this
_C.MODEL.VSSM.EMBED_DIM = 96 #? What is this
