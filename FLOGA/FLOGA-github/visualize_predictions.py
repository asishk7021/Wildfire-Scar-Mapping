...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='/mnt/FLOGA/FLOGA-github/configs/config.json', required=False,
    ...
    parser.add_argument('--mode', type=str, choices=['train', 'val', 'test'], default='test', required=False,
                        help='The dataset split to produce predictions for. Default "test".')
