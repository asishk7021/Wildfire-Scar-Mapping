...
configs['method'] = 'bam_cd'
model_configs = pyjson5.load(open(Path('/mnt/FLOGA/FLOGA-github/configs') / 'method' / f'{configs["method"]}.json', 'r'))
configs['mode'] = 'eval'
configs['paths']['load_state'] = '/mnt/FLOGA/data/results/bam_cd/20240709105612/checkpoints/0/best_segmentation.pt'

run_path, resume_from_checkpoint, _ = resume_or_start(configs, model_configs)
results_path = Path('/mnt/FLOGA/gradio_outputs/bam_cd/')
