...
configs['method'] = 'fc_ef_conc'
model_configs = pyjson5.load(open(Path('/mnt/FLOGA/FLOGA-github/configs') / 'method' / f'{configs["method"]}.json', 'r'))
configs['mode'] = 'eval'
configs['paths']['load_state'] = '/mnt/FLOGA/data/results/fc_ef_conc/20240709062729/checkpoints/0/best_segmentation.pt'

run_path, resume_from_checkpoint, _ = resume_or_start(configs, model_configs)
results_path = Path('/mnt/FLOGA/gradio_outputs/fc_ef_conc/')
