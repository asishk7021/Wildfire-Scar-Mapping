...
configs['method'] = 'adhr_cdnet'
model_configs = pyjson5.load(open(Path('/mnt/FLOGA/FLOGA-github/configs') / 'method' / f'{configs["method"]}.json', 'r'))
configs['mode'] = 'eval'
configs['paths']['load_state'] = '/mnt/FLOGA/data/results/adhr_cdnet/20240709035419/checkpoints/0/best_segmentation.pt'

run_path, resume_from_checkpoint, _ = resume_or_start(configs, model_configs)
results_path = Path('/mnt/FLOGA/gradio_outputs/adhr_cdnet/')
